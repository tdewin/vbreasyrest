...
$port = 9419
$src = Get-VBRRestGUI -server "https://127.0.0.1" -port $port -login $user  -insecure -Verbose
$tgt = Get-VBRRestGUI -server "https://127.0.0.2" -port $port -login $user -insecure -Verbose
